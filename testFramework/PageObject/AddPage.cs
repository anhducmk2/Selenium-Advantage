...
namespace testFramework.PageObject
{
    public class AddPage : WebDriverAction
    {
        ...
        private readonly string firstname = "Anh";
        private readonly string lastname = "Duc";
        private readonly string email = "anhducmk2@gmail.com";
        private readonly string age = "23";
        private readonly string salary = "20000";
        private readonly string department = "Ha Noi";
